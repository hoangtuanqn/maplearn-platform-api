...
class CourseCompletionExamRequiredNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Bạn vừa hoàn thành toàn bộ nội dung bài học của **' . $this->course->name . '** – một hành trình thật sự đáng tự hào.')
            ->line('Để chính thức hoàn thành khóa học và nhận chứng chỉ, bạn cần vượt qua thử thách cuối cùng: **' . $this->exam->title . '**.')
